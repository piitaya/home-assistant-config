...
class BambuNfcOnTagSuccessTrigger : public Trigger<> {};
class BambuNfcOnTagErrorTrigger : public Trigger<> {};
...
class BambuNfc : public pn532::PN532,
 ...
 public:
  ...
  void set_material_id_sensor(text_sensor::TextSensor *s) { material_id_sensor_ = s; }
  ...
  void register_on_tag_success_trigger(BambuNfcOnTagSuccessTrigger *t) { on_tag_success_triggers_.push_back(t); }
  void register_on_tag_error_trigger(BambuNfcOnTagErrorTrigger *t) { on_tag_error_triggers_.push_back(t); }
 ...
 protected:
  ...
  text_sensor::TextSensor *material_id_sensor_{nullptr};
  ...
  std::vector<BambuNfcOnTagSuccessTrigger *> on_tag_success_triggers_;
  std::vector<BambuNfcOnTagErrorTrigger *> on_tag_error_triggers_;
};
